            ...
            <div class="panel-collapse collapse in" role="tabpanel" id="kraj_presovsky"  aria-expanded="true">
              <div class="panel-body">
                <ul class="nav">
                   ...
                   <li><a href="">Humenné</a></li>
                   <li><a href="">Kežmarok</a></li>
                   <li><a href="">Levoča</a></li>
                   <li><a href="">Medzilaborce</a></li>
                   <li><a href="">Poprad</a></li>
                   <li class="active"><a href="">Prešov</a></li>
                   <li><a href="">Sabinov</a></li>
                   <li><a href="">Snina</a></li>
                   <li><a href="">Stará Ľubovňa</a></li>
                   <li><a href="">Stropkov</a></li>
                   <li><a href="">Svidník</a></li>
                  <li><a href="">Vranov nad Topľou</a></li>
                </ul>
              </div>
            </div>
          </div>
